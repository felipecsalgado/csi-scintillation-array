...
private:
  ...
  // Magnet Gap
  G4VSolid *fMagnetGapSolid;
  G4LogicalVolume *fMagnetGapLogical;
  G4VPhysicalVolume *fMagnetGapPhys;
  ...
  G4double           separator_thickness;
  G4double nStacks = 51.;
  G4Material*        separator_material;
  G4Box*             fSolidSep;
  G4LogicalVolume*   fLogicSep;
  G4VPhysicalVolume* fPhysiSep;
